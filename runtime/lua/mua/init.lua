...
-- the tool call, or a table to rewrite the tool's arguments to that table (the
-- rewritten args are what runs, still subject to approval); other events ignore
-- the return. The nvim_create_autocmd shape.
